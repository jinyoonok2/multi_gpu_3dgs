...
class alignas(256) ColumeLRs {
public:
    float step_size[64];// 64*4 bytes
    // what is the size of cache line?
};

#define STEP_FUSED(SPAN)                                     \
    void Step_fused_##SPAN(float* _params,                   \
                     float* grads,                           \
                     float* _exp_avg,                        \
                     float* _exp_avg_sq,                     \
...
public:
    ...
    void Step_sparse_group_1(float* _params,
                             float* grads,
                             float* _exp_avg,
                             float* _exp_avg_sq,
                             int *row_indices,
    ...
    void Step_sparse_fused_1_v1(float* _params,
                                float* grads,
                                float* _exp_avg,
                                float* _exp_avg_sq,
                                int* row_indices,
    ...
    void Step_sparse_fused_1_v2(float* _params,
                                float* grads,
                                float* _exp_avg,
                                float* _exp_avg_sq,
                                int* row_indices,
    ...
    void Step_sparse_fused_1_v3(float* _params,
                                float* grads,
                                float* _exp_avg,
                                float* _exp_avg_sq,
                                int* row_indices,
    ...
    void set_columns_lrs(ColumeLRs& columns_lrs_class,
                     int* columns_offsets,
                     float xyz_lr,
                              ...
                              size_t _param_size)
{
    ...
    // printf("AVX Step\n"); // AVX version code will indeed call this function, because we see this output. 
    AVX_Data betta1_4;
